        ...
        <div className="section-container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg text-muted-foreground space-y-6">
              <p>RallyRoo was born from a simple love of RC trucks and the great Australian outdoors. We noticed that finding quality RC vehicles in Australia often meant paying inflated prices or compromising on durability and performance.</p>
              <p>We set out to change that. Today, we curate the best RC trucks from around the world, ensuring every product meets our standards for quality, durability, and fun. Whether you're a first-time buyer looking for a backyard basher or an experienced hobbyist chasing the next challenge, we've got you covered.</p>
              <p>Based in Melbourne, we're proud to deliver our products to every corner of Australia – from bustling cities to remote outback towns. Because adventure shouldn't have to wait.</p>
            </div>
          </div>
        </div>
      </section>
