        ...
        <div className="section-container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg text-muted-foreground space-y-6">
              <p>RallyRoo was born from a simple love of RC trucks and the great Australian outdoors. We noticed that finding quality RC vehicles in Australia often meant paying inflated prices or waiting weeks for international shipping.</p>
