        ...
        <div className="section-container relative py-20 md:py-32">
          <div className="max-w-2xl">
            ...
            animationDelay: "300ms"
              ...
              <Button asChild size="lg" variant="ghost" className="bg-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/30 hover:text-primary-foreground backdrop-blur-sm">
